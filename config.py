...
def set_template(args):
    if args.dataset_code == None:
        ...
        args.dataset_code = dataset_code['b']
...
# LLM Model
################
# Use distilgpt2 - smaller, no auth required, widely available
parser.add_argument('--llm_base_model', type=str, default='distilbert/distilgpt2')
parser.add_argument('--llm_base_tokenizer', type=str, default='distilbert/distilgpt2')
...
# Use GPT2 module names: c_attn contains Q, K, V projections
parser.add_argument('--lora_target_modules', type=list, default=['c_attn', 'c_proj'])
